...
- [Eugene Obrezkov](https://github.com/ghaiklor) [@ghaiklor](https://twitter.com/ghaiklor) - Based in Kirovohrad, Ukraine (UTC+2). I had stopped working with JavaScript for UI and now I'm working with REST API, own open source libraries, contributing and many others. NodeSchool Kirovohrad Chapter organizer.
